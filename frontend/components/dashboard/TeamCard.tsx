        ...
        <div className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div className="flex-1 min-w-0">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 line-clamp-1">{name}</h3>
            ...
            <Button
              ...
              size="sm"
              onClick={onInvite}
              className="flex-shrink-0 flex items-center justify-center gap-2 hover:bg-gray-100"
            >
